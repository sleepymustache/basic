...
\begin{DoxyItemize}
\item Changed to a static class pattern
\end{DoxyItemize}
...
Exception Handler \hypertarget{class_debug_ab018ff0e2ab4f2d17353586f25d955a8}{\index{Debug@{Debug}!out@{out}}
\index{out@{out}!Debug@{Debug}}
\subsubsection[{out}]{\setlength{\rightskip}{0pt plus 5cm}out (
\begin{DoxyParamCaption}
\item[{}]{\$var}
\end{DoxyParamCaption}
)}}\label{class_debug_ab018ff0e2ab4f2d17353586f25d955a8}
...
string Database Host \hypertarget{class_debug_a68f39949e76b64662a06cb56579d91c3}{\index{Debug@{Debug}!\$db\-Name@{\$db\-Name}}
...
string Database Name \hypertarget{class_debug_a30d808caf55f524798c6a5aaafd633ad}{\index{Debug@{Debug}!\$db\-Pass@{\$db\-Pass}}
...
string Database Password \hypertarget{class_debug_adfd23e5286c56c7632ecb55887dd2555}{\index{Debug@{Debug}!\$db\-Table@{\$db\-Table}}
...
string Database Table to use for logging \hypertarget{class_debug_a4a92606de85aafdc0dcae4976b7ca669}{\index{Debug@{Debug}!\$db\-User@{\$db\-User}}
...
string Database User Name \hypertarget{class_debug_ace2c8fd77a23d56cfdc35a142df1b1ab}{\index{Debug@{Debug}!\$email\-B\-C\-C@{\$email\-B\-C\-C}}
...
string Email address bcc send email to. \hypertarget{class_debug_a6da5505f5274a47a70fb0cbac5eef25e}{\index{Debug@{Debug}!\$email\-Buffer@{\$email\-Buffer}}
...
string\mbox{[}\mbox{]} The body of the email. \hypertarget{class_debug_aef55490ba633a1821bc784c7c5e5a5e5}{\index{Debug@{Debug}!\$email\-C\-C@{\$email\-C\-C}}
...
string Email address cc send email to. \hypertarget{class_debug_a8812e953c70aa15f8f01e0a83230e645}{\index{Debug@{Debug}!\$email\-From@{\$email\-From}}
...
string Email address to send email from. \hypertarget{class_debug_afc4243e1cc62688011c169b622433f64}{\index{Debug@{Debug}!\$email\-Subject@{\$email\-Subject}}
...
string The subject of the email. \hypertarget{class_debug_a2dca3002fa879522effbe7bd729d681d}{\index{Debug@{Debug}!\$email\-To@{\$email\-To}}
...
string Email address to send email to. \hypertarget{class_debug_abf6da1366fe6b13a73e55c0962433b5f}{\index{Debug@{Debug}!\$enable\-\_\-log@{\$enable\-\_\-log}}
...
bool Enabled logging to a database \hypertarget{class_debug_aeb64a58109ab72544114d51e42a3ca4f}{\index{Debug@{Debug}!\$enable\-\_\-send@{\$enable\-\_\-send}}
...
bool Enabled logging via email \hypertarget{class_debug_a5789d2d16b0d24dc6aa96b63b4f6f605}{\index{Debug@{Debug}!\$enable\-\_\-show@{\$enable\-\_\-show}}
