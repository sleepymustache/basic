...
This abstract class is to ensure that only one P\-D\-O instance is used. You get a instance of the database with\-:\hypertarget{robo1_usage}{}\section{Usage\-:}\label{robo1_usage}
