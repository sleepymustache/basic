...
Definition at line 31 of file class.\-fsdb.\-php.
...
Definition at line 70 of file class.\-fsdb.\-php.


\begin{DoxyCode}
                                                  \{
                              \textcolor{keywordflow}{if} (!file\_exists($file)) \{
                                             $newFile = fopen($file, \textcolor{charliteral}{'w'});
                                             fclose($newFile);
                              \}

                              $this->file = $file;

                              $this->handle = fopen($this->file, \textcolor{stringliteral}{"a+"});

                              \textcolor{keywordflow}{if} ($this->handle) \{
                                             fseek($this->handle, 0);
                                             $this->getLock($file);
                              \} \textcolor{keywordflow}{else} \{
                                             \textcolor{keywordflow}{throw} \textcolor{keyword}{new} Exception(\textcolor{stringliteral}{'FSTable:
       Could not open file'});
                              \}
               \}
\end{DoxyCode}
...
Definition at line 92 of file class.\-fsdb.\-php.


\begin{DoxyCode}
                                            \{
                              \textcolor{keywordflow}{if} ($this->edited) \{
                                             $this->save();
                              \}
                              \textcolor{keywordflow}{if} ($this->locked) \{
                                             flock($this->handle, LOCK\_UN);
                              \}
                              \textcolor{keywordflow}{if} ($this->handle) \{
                                             fclose($this->handle);
                              \}
...
Definition at line 280 of file class.\-fsdb.\-php.
...
\begin{DoxyCode}
                              ...
                              \textcolor{keywordflow}{foreach}($this->data as $key => $value) \{
                                             \textcolor{keywordflow}{if} ($value->$column == $search) \{
                                                            array\_splice(
      $this->data, $key, 1);
                                                            $updated++;
                                             \}
...
Definition at line 266 of file class.\-fsdb.\-php.
...
Definition at line 189 of file class.\-fsdb.\-php.
...
\begin{DoxyCode}
                              ...
                              \textcolor{keywordflow}{if} ($column == \textcolor{stringliteral}{"*"}) \{
                                             \textcolor{keywordflow}{return} $this->data;
                              \}

                              \textcolor{keywordflow}{if} (count($this->data) == 0) \{
                                             \textcolor{keywordflow}{return} array();
                              \}

                              \textcolor{keywordflow}{foreach}($this->data as $row) \{
                                             \textcolor{keywordflow}{if} ($row->$column == $search) \{
                                                            $results[] = $row;
                                             \}
                              \}
...
Definition at line 217 of file class.\-fsdb.\-php.
...
\begin{DoxyCode}
                              ...
                              \textcolor{keywordflow}{foreach}($this->data as $row) \{
                                             \textcolor{keywordflow}{if} ($row->$column > $lower && $row
      ->column < $upper) \{
                                                            $results[] = $row;
                                             \}
                              \}
...
Definition at line 239 of file class.\-fsdb.\-php.
